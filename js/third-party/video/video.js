...
(function () {
    ...
    t.play = function () {
        // commLog.creatEvent({"id":77,"url":window.location.href,"keyword":"视频播放","browseType":"38"});
        L(this, "play");
        return this
    };
    t.pause = function () {
    ...
    t.paused = function () {
        // commLog.creatEvent({"id":78,"url":window.location.href,"keyword":"视频播放暂停","browseType":"38"});
    ...
    u.Ea.prototype.p = function () {
        this.c.isFullScreen() ? (this.c.cancelFullScreen(), this.a.children[0].children[0].innerHTML = "Fullscreen", commLog.creatEvent({"id":82,"url":window.location.href,"keyword":"视频播放手动缩小","browseType":"38"})) : (this.c.requestFullScreen(), this.a.children[0].children[0].innerHTML = "Non-Fullscreen", commLog.creatEvent({"id":81,"url":window.location.href,"keyword":"视频播放全屏","browseType":"38"}))
    };
    u.fb = u.b.extend({
        j: function (a, c) {
            u.b.call(this, a, c)
