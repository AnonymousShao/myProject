        ...
        23: [function(require, module, exports) {
            ...
            module.exports = function(Chart) {
                ...
                Chart.Controller = function(instance) {
                    ...
                    this.dataList= instance.config.data.datasets;
                    this.labels= instance.config.data.labels;
                        ...
                        if (opts.display) {
                            ...
                            if (!opts.lineArc) {
                                ...
                                for (var i = me.getValueCount() - 1; i >= 0; i--) {
                                    ...
                                    arrX.push(pointLabelPosition.x)
                                    arrY.push(pointLabelPosition.y)
                                    if (arrX.length==me.getValueCount()){
                                        pPosition= {arrX:arrX,arrY:arrY}
                                    }
                                }
                            }
                        }
