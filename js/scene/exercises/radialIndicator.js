...
;(function ($, window, document) {
    ...
    Indicator.prototype = {
        ...
        init: function () {
            ...
            ctx.beginPath();
            //ctx.arc(center, center, indOption.radius, 0, 2 * Math.PI);  //fix on 20161109
            ctx.stroke();
        ...
        value: function (val) {
            ...
            var perVal = Math.round(((val - minVal) * 100 / (maxVal - minVal)) * 100) / 100, //percentage value tp two decimal precision
                ...
                dispVal = indOption.percentage ? ''+"" +'' : this.formatter(val);
            //save val on object
            ...
            ctx.beginPath();
            ctx.arc(center, center, indOption.radius-5, -(quart), ((circ) * perVal / 100) - quart, false);
            ctx.stroke();
    ...
    radialIndicator.defaults = {
        ...
        barColor: '#eeeeee', //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 100: '#000'}
